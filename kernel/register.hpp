...
/**
 * MemMapRegister is wrapper for a memroy mapped register.
 *
 ...
 * should have Size() method and Iterator tye.
 * Size() should return the number of elements, and itertors
...
class ArrayWrapper {
 public:
  ...
  // begin, end, cbegin, cend must be lower came names
